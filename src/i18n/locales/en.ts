...
export const en = {
  ...
  about: {
    ...
    features: [
      'To build on our expertise, we harness big data and machine learning—the engine behind HeatVision®—to continuously refine the gears that drive precise production control.',
      'Our multilingual team, fluent in Mandarin, English, and several other languages, enables smooth collaboration between global customers and manufacturing counterparts.',
      "We prioritize, always, what's best for our partner, creating lasting value.",
    ],
  },
  expertise: {
    titleLight: 'OUR',
